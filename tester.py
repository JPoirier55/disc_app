...
def run():
    ...
    url2 = "https://maps.googleapis.com/maps/api/geocode/json?address=Toledo&key=AIzaSyAuZbeei_JtF-5mHhcSw6uZ9L0__8hcqgk"
    url3 = "https://maps.googleapis.com/maps/api/geocode/json?latlng=40.714224,-73.961452&key=AIzaSyAuZbeei_JtF-5mHhcSw6uZ9L0__8hcqgk"
    r = requests.get(url3)
    for resp in r:
        print(resp)
